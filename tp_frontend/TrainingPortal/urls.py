...
urlpatterns = patterns('',
   ...
   # url(r'^progress-stat/$', 'review.user.progress'),
    ...
    url(r'^bulk-testing/$', 'review.upload.upload'),
    url(r'^mass-training/$', 'review.download.mass_training'),
    url(r'^cuisine_selection/$', 'CuisineSelection.cuisine.select_cuisine'),
    url(r'^generate-questions/$', 'CuisineSelection.cuisine.generate_questions'),
    url(r'^generate-questions/progress', 'CuisineSelection.cuisine.check_question_gen_progress'),
