...
""" 
t1 = time.time()
mongoDumpFromConceptDigger = socket_sender.sendPacketOverSocket(config.conceptDiggerHostAddress, config.conceptDiggerPort, seedCategories)
...
f.write(mongoDumpFromConceptDigger)
t2 = time.time()
